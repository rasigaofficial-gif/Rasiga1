        ...
        <div style="position: relative; margin-bottom: 2rem; z-index: 50;">
          <div class="glass page-enter" style="padding: 1.5rem; animation-delay: 0.05s;">
            ...
            <div style="position:relative; display:flex; align-items:center;">
              <input type="text" id="discover-search-input" class="glass-input" style="width: 100%; padding-right: 2.5rem;" placeholder="Search songs..." aria-label="Search songs" oninput="if(window.RasigaApp && RasigaApp.executeGlobalSearch) RasigaApp.executeGlobalSearch(this.value, 'discover-search-input'); document.getElementById('discover-clear-btn').style.display = this.value ? 'block' : 'none';">
              <button id="discover-clear-btn" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: transparent; border: none; color: var(--text-muted); cursor: pointer; display: none; padding: 0;" onclick="document.getElementById('discover-search-input').value=''; if(window.RasigaApp && RasigaApp.executeGlobalSearch) RasigaApp.executeGlobalSearch('', 'discover-search-input'); this.style.display='none';" aria-label="Clear search">
                ${window.Icons ? window.Icons.get('x', { width: 18, height: 18 }) : '✕'}
              </button>
            </div>
          </div>

          <div id="discover-search-filter" class="custom-dropdown-container page-enter" data-value="all" style="position: absolute; top: 1.25rem; right: 1.5rem; z-index: 90; animation-delay: 0.05s;">
